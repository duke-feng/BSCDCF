...
% <
[seq, im] = get_sequence_info(params.seq);   %%% 获得序列信息，以及第一帧
...
% Calculate search area and initial scale factor 计算搜索区域和初始比例因子
% <
...
% Pre-computes the grid that is used for socre optimization预计算用于优化的网格
% <
%filter_sz_cell{1}(1);
...
% Construct the Gaussian label function, cosine window and initial mask构造高斯标签函数，余弦窗口和初始蒙版
% <
